...
class FormularioMascaras extends TPage{
    public function __construct(){
        ...
        $element1 = new TEntry('elemento1');
        $element2 = new TEntry('elemento2');
        $element3 = new TEntry('elemento3');
        $element4 = new TEntry('elemento4');
        $element5 = new TEntry('elemento5');
        $element6 = new TEntry('elemento6');
        $element7 = new TEntry('elemento7');
        $element8 = new TEntry('elemento8');
        $element9 = new TEntry('elemento9');
        $element10 = new TEntry('elemento10');
        $element11 = new TEntry('elemento11');
        $element12 = new TEntry('elemento12');
        $element13 = new TEntry('elemento13');
        $element14 = new TEntry('elemento14');
