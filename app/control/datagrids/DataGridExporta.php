...
class DataGridExporta extends TPage{
    ...
    public function __construct(){
        ...
        $panel->addHeaderActionLink('Salvar PDF', new TAction([$this, 'exportarPDF'], ['register_state' => 'false']), 'fas:file-pdf red');
        $panel->addHeaderActionLink('Salvar CSV', new TAction([$this, 'exportarCSV'], ['register_state' => 'false']), 'fa:table blue');
        
        parent::add($panel);
    }
    
    public function exportarPDF($param){
        try{
